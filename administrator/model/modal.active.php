<div  id="active-<?php echo $view['id_reservasi']; ?>" class="modal fade" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-lg animated--grow-in" role="document">
        <div class="modal-content">
          <div class="modal-body">
            <h4>Aktifkan reservasi ? <?php echo $view['nama_pengguna']; ?> - <?php echo $view['id_reservasi']; ?> </h4>
          </div>
          <div class="modal-footer bg-info">
            <form class="" action="control/script.reservation" method="post">
              ...
              <button type="submit" name="active" class="btn btn-success btn-outline btn-block"> Ya</button>
            </form>

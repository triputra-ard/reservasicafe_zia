    ...
    <table id="Admin_table" class="table table-bordered table-hover">
      ...
      <tbody class="text-dark">
        ...
        $sql = "SELECT * FROM `transaksi` a
         ...
         Where a.id_user = '$user' AND c.status_reservasi = 'SELESAI'";
        ...
        <?php while ($view = mysqli_fetch_assoc($query)) {
          ...
          // code..?><tr>
            ...
            <td>
              <a href="menu?menu=reserved_menu&id=<?php echo encrypt($view['id_reservasi']); ?>&status=<?php echo $view['status_reservasi']; ?>" class="btn btn-primary btn-rounded"> <i class="fas fa-info-circle"></i> Lihat informasi lengkap</a>
            </td>
          </tr>
